...
echo "<html><head><style>body {font-family: Helvetica, sans-serif;}</style></head><body><br><br><br><br><br><br><center><img src='https://mk0getcloudify4yiua1.kinstacdn.com/wp-content/uploads/2017/01/Cloudify_Logo_horizontal.png' width='500' height='162'><br><br><h1>${message}</h1></body></html>" | sudo tee /etc/nginx/www/index.html
